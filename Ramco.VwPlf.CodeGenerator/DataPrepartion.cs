    ...
    public class DataPrepartion
    {
        ...
        private void AddDataRelationToServiceDataset(ref DataSet dsService)
        {
            ...
            catch (Exception ex)
            {
                ...
                {
                    _logger.WriteLogToFile("DownloadService", "Null Data not Allowed.Null handling should be done in the sp 'vw_netgen_serviceschema_sp'");
                }
        ...
        public DataSet DownloadService(UserInputs userInputs)
        {
            ...
            try
            {
                if (userInputs.DataMode.Equals(DataMode.Model))
                {
                    ...
                    dsService = _dbManager.ExecuteDataSet(CommandType.StoredProcedure, "vw_netgen_serviceschema_sp", parameters);
                    ...
                    //dsService.Tables[10].TableName = "ApiRequest";
                    //dsService.Tables[11].TableName = "ApiResponse";
                    //dsService.Tables[12].TableName = "ApiParameter";
                    //dsService.Tables[13].TableName = "ApiOperationalParameter";
